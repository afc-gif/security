...
<head>
    ...
    <title>Server Error | ARTSCI Security</title>
...
<body class="bg-gray-50 flex items-center justify-center min-h-screen p-4 text-gray-800">
    <div class="max-w-md w-full bg-white rounded-xl shadow-lg border border-gray-200 p-8 text-center">
        ...
        <h1 class="text-2xl font-bold text-gray-900 mb-2">Server Error (500)</h1>
        <p class="text-gray-600 mb-6 text-sm">
            An unexpected error occurred while processing your request. Please refresh or try again.
        </p>
