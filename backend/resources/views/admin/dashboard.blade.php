        ...
        <div class="panels">
            ...
            <section class="panel" data-section="menu">
                <div class="card">
                    ...
                    <div style="background:#f8fbff; border:1px solid var(--brand-border); border-radius:14px; padding:16px; margin-bottom:16px;">
                        ...
                        <form id="menuForm" style="display:grid; gap:10px;">
                            <div style="display:grid; grid-template-columns:repeat(auto-fit, minmax(200px, 1fr)); gap:10px;">
                                <div>
                                    <label style="font-size:13px; color:var(--brand-muted); margin-bottom:4px; display:block;">Product Name *</label>
                                    <input name="name" placeholder="e.g. CCTV Camera" required style="width:100%; padding:10px 12px; border:1px solid var(--brand-border); border-radius:10px; font:inherit; background:#fff;" />
                                </div>
                                <div>
                                    <label style="font-size:13px; color:var(--brand-muted); margin-bottom:4px; display:block;">Barcode (Optional)</label>
                                    <input name="barcode" placeholder="Auto-generate if blank" style="width:100%; padding:10px 12px; border:1px solid var(--brand-border); border-radius:10px; font:inherit; background:#fff;" />
                                </div>
                                <div>
                                    <label style="font-size:13px; color:var(--brand-muted); margin-bottom:4px; display:block;">Price (NGN) *</label>
                                    <input name="price" type="number" step="0.01" min="0" required style="width:100%; padding:10px 12px; border:1px solid var(--brand-border); border-radius:10px; font:inherit; background:#fff;" />
                                </div>
                                <div>
                                    <label style="font-size:13px; color:var(--brand-muted); margin-bottom:4px; display:block;">Stock Quantity</label>
                                    <input name="stock" type="number" min="0" value="0" style="width:100%; padding:10px 12px; border:1px solid var(--brand-border); border-radius:10px; font:inherit; background:#fff;" />
                                </div>
                            </div>

                            <div style="display:grid; grid-template-columns:repeat(auto-fit, minmax(200px, 1fr)); gap:10px;">
                                <div>
                                    <label style="font-size:13px; color:var(--brand-muted); margin-bottom:4px; display:block;">Category *</label>
                                    <select name="category_id" id="menuCategorySelect" required style="width:100%; padding:10px 12px; border:1px solid var(--brand-border); border-radius:10px; font:inherit; background:#fff;">
                                        <option value="" disabled selected>Select category</option>
                                    </select>
                                </div>
                                <div>
                                    <label style="font-size:13px; color:var(--brand-muted); margin-bottom:4px; display:block;">Image</label>
                                    <input name="image" type="file" accept="image/*" style="width:100%; padding:10px 12px; border:1px solid var(--brand-border); border-radius:10px; font:inherit; background:#fff;" />
                                </div>
                            </div>

                            <div>
                                <label style="font-size:13px; color:var(--brand-muted); margin-bottom:4px; display:block;">Description (Optional)</label>
                                <textarea name="description" rows="2" placeholder="Add product details..." style="width:100%; padding:10px 12px; border:1px solid var(--brand-border); border-radius:10px; font:inherit; background:#fff;"></textarea>
                            </div>

                            <label style="display:flex; align-items:center; gap:8px; margin-top:8px; cursor:pointer;">
                                <input name="display_on_website" type="checkbox" value="1" checked style="width:18px; height:18px; cursor:pointer;" />
                                <span style="font-size:13px;">Display on Website</span>
                            </label>
                    ...
                    <div>
                        <h3 style="margin:0 0 12px; font-size:16px;">Recent Products</h3>
                        <div class="list" id="menuList" style="border:1px solid var(--brand-border); border-radius:12px; overflow:hidden; box-shadow:0 2px 8px rgba(0,0,0,0.04);"></div>
                        <div style="text-align:center; margin-top:12px;">
                            <a href="{{ route('admin.products.index') }}" style="color:#2563eb; font-weight:600; font-size:13px; text-decoration:none;">View complete products list →</a>
                        </div>
                    </div>
                </div>
            </section>
