...
<div class="min-h-screen bg-gray-50">
    <div class="max-w-5xl mx-auto px-4 py-6 sm:px-6 lg:px-8">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
            ...
            <a href="{{ route('finance.expenses.index') }}" class="inline-flex items-center justify-center bg-gray-200 hover:bg-gray-300 text-gray-800 px-5 py-2.5 rounded-lg font-semibold transition">
                Back to Expenses
            </a>
        </div>
        ...
        <div class="bg-white rounded-lg border border-gray-200 shadow-sm p-6 mt-6">
            ...
            <div class="flex flex-col sm:flex-row gap-3">
                @if($expense->status === \App\Models\FinancialExpense::STATUS_PENDING)
                    ...
                    @endcan
                @else
                    <div class="text-gray-600">Approved and rejected records are preserved and cannot be edited from this Phase 2 workflow.</div>
                @endif
            </div>
        </div>
    </div>
