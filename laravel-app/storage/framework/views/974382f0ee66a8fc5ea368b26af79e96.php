...
<aside class="admin-sidebar">
    ...
    <nav class="admin-nav">
        ...
        <a href="<?php echo e(route('categories.index')); ?>" class="nav-item <?php echo e($active === 'categories' ? 'active' : ''); ?>">
            <i class="fas fa-list"></i> Categories
        </a>
        <a href="<?php echo e(route('menu-items.index')); ?>" class="nav-item <?php echo e($active === 'menu-items' ? 'active' : ''); ?>">
...
<?php /**PATH /home/codecps/security/laravel-app/resources/views/admin/partials/sidebar.blade.php ENDPATH**/ ?>