...
<body>
    <header>
        <div style="display:flex; align-items:center; gap:12px;">
            <img src="<?php echo e(asset('Artsci Logo REAL 1.webp')); ?>" alt="ARTSCI" style="width:42px; height:42px; border-radius:12px; object-fit:contain;">
            <div>
                <p class="brand-title">POS · ARTSCI</p>
                <p class="brand-tag">Signed in as <?php echo e(auth()->user()->name ?? 'POS User'); ?></p>
            </div>
        </div>
...
<?php /**PATH /var/www/html/resources/views/pos/index.blade.php ENDPATH**/ ?>