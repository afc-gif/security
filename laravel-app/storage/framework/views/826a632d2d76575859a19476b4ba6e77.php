...
<body>
  ...
  <div class="solutions-container">
    <?php if($solutions->count() > 0): ?>
      <div class="solutions-grid">
        <?php $__currentLoopData = $solutions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <div class="product-card">
            <?php if($product->image): ?>
              <img src="<?php echo e(Storage::disk('public')->url($product->image)); ?>" alt="<?php echo e($product->name); ?>" class="product-image">
            <?php else: ?>
            ...
            <div class="product-content">
              <div class="product-category"><?php echo e($product->solution->name ?? 'Solution'); ?></div>
              ...
              <div class="product-footer">
                <div>
              <div class="product-price">₦<?php echo e(number_format($product->price ?? 0, 2)); ?></div>
              <div class="product-barcode" style="font-size: 12px; color: #666;"><?php echo e($product->barcode); ?></div>
            </div>
            <div style="text-align: right;">
              <div style="font-size: 14px; font-weight: 600; color: var(--primary-blue);">Stock: <?php echo e($product->stock ?? 'N/A'); ?></div>
            </div>
              </div>
            </div>
          </div>
...
<?php /**PATH /var/www/html/resources/views/shop/solutions.blade.php ENDPATH**/ ?>