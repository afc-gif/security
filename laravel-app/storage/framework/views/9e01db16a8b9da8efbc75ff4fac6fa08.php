<?php $__env->startSection('title', 'Add Category - Admin - ARTSCI'); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group">
                    <label>
                        <input type="checkbox" name="active" value="1" <?php echo e(old('active') ? 'checked' : ''); ?>>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/codecps/security/laravel-app/resources/views/admin/categories/create.blade.php ENDPATH**/ ?>