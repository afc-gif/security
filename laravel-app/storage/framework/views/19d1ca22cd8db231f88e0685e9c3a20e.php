...
<head>
  ...
  <link rel="icon" type="image/webp" href="<?php echo e(asset('Artsci Logo REAL 1.webp')); ?>" />
  <link rel="apple-touch-icon" href="<?php echo e(asset('Artsci Logo REAL 1.webp')); ?>" />
  <link rel="preconnect" href="https://fonts.googleapis.com">
  <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
  <link href="https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600;700;800;900&family=Space+Mono:wght@400;700&display=swap" rel="stylesheet">
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css" />
  <link rel="stylesheet" href="<?php echo e(asset('modern-design.css')); ?>" />
</head>
<body>
  <!-- Premium Navigation -->
  <nav class="navbar">
    <div class="nav-container">
      <div class="nav-logo">
        <img src="<?php echo e(asset('Artsci Logo REAL 1.webp')); ?>" alt="ARTSCI" class="logo-img">
  ...
  <section class="hero">
    <div class="hero-media">
      <img class="hero-slide-bg active" src="<?php echo e(asset('Desktop-012.webp')); ?>" alt="High-tech security operations center" />
      <img class="hero-slide-bg" src="<?php echo e(asset('Desktop-013.webp')); ?>" alt="Central command station display wall" />
      <img class="hero-slide-bg" src="<?php echo e(asset('Desktop-014.webp')); ?>" alt="Enterprise surveillance workspace" />
      <img class="hero-slide-bg" src="<?php echo e(asset('Desktop-015.webp')); ?>" alt="Security network monitoring dashboard" />
    </div>
  </section>
    ...
    <div class="container">
      ...
      <div class="partners-grid">
        <div class="partner-logo">
          <img src="<?php echo e(asset('dahua png.png')); ?>" alt="DAHUA">
        </div>
        <div class="partner-logo">
          <img src="<?php echo e(asset('hikvision png2.png')); ?>" alt="HIKVISION">
        </div>
        <div class="partner-logo">
          <img src="<?php echo e(asset('amcrest 2.png')); ?>" alt="AMCREST">
        </div>
        <div class="partner-logo">
          <img src="<?php echo e(asset('centurion.png')); ?>" alt="CENTURION">
        </div>
        <div class="partner-logo">
          <img src="<?php echo e(asset('felicity logo PNG2.png')); ?>" alt="FELICITY">
        </div>
        <div class="partner-logo">
          <img src="<?php echo e(asset('deye 1.png')); ?>" alt="DEYE">
        </div>
        <div class="partner-logo">
          <img src="<?php echo e(asset('growatt 1.png')); ?>" alt="GROWATT">
        </div>
        <div class="partner-logo">
          <img src="<?php echo e(asset('nemtek 1.png')); ?>" alt="NEMTEK">
        </div>
      </div>
    </div>
  </section>
    ...
    <div class="container">
      <div class="footer-top">
        <div class="footer-logo-section">
          <img src="<?php echo e(asset('Artsci Logo REAL 1.webp')); ?>" alt="ARTSCI Logo" class="footer-logo">
          <div>
            <h3>ARTSCI</h3>
  ...
  <script src="<?php echo e(asset('modern-interactions.js')); ?>"></script>
</body>
</html>
